...
interface Props {
    window?: () => Window; // Opcional para manejo de ventanas (ej. iframe)
}
...
export default function DrawerAppBar(props: Props) {
    ...
    // Función para navegar a los diferentes divs
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <nav>
                <Drawer
                    ...
                    ModalProps={{
                        keepMounted: true, // Mejora el rendimiento al abrir en dispositivos móviles
                    }}
                    sx={{
